...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Cheluve Creations — Alankara of Every Cheluve" },
      ...
      { name: "google-site-verification", content: "WUPscOkvinJt8CV4xPmLbcsZyVr2TdqvB10v1SAqwfI" },
    ],
    links: [
    ...
    scripts: [
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          logo: "https://cheluve-revive.lovable.app/favicon.ico",
